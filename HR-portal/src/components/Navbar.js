            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-16">
                    <Link to="/" className="flex items-center gap-2 lg:gap-3 transition flex-shrink-0">
                        <img src={logo} alt="Codexa Logo" className="h-10 md:h-12 w-auto rounded-lg" />
                        <div className="flex flex-row items-center gap-1.5 md:gap-2 leading-none whitespace-nowrap">
                            <span className={`text-sm md:text-lg xl:text-xl font-black tracking-tight xl:tracking-[0.1em] uppercase transition-colors duration-300 ${isScrolled ? 'text-[#8a6144]' : 'text-white'}`}>CODEXA</span>
                        </div>
                    </Link>
