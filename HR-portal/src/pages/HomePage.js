...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#fff5e6] via-[#f5e6d3] to-[#fff5e6] dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex flex-col justify-center items-center py-12 md:py-20 px-4 transition-colors duration-300 overflow-x-hidden">
      ...
      >
        <img src={logo} alt="Codexa Logo" className="h-24 w-auto mx-auto rounded-2xl shadow-xl hover:scale-105 transition-transform duration-300" />
      ...
      >
        <div className="text-center mb-8 md:mb-12">
          <span className="text-[#8a6144] dark:text-[#d4a081] font-bold tracking-widest text-sm uppercase">Why Codexa HR?</span>
      ...
      >
        ...
        <p className="text-black/80 dark:text-gray-300 mb-8 max-w-xl mx-auto relative z-10">Join Codexa and experience the future of HR management today.</p>
