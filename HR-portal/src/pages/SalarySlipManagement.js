...
const SalarySlipManagement = () => {
    ...
    const handleEditSlip = (slip) => {
        ...
        setEditCompanyName(slip.companyName || latestCompanyInfo?.companyName || 'Codexa');
        setEditCompanyAddress(slip.companyAddress || latestCompanyInfo?.companyAddress || 'Codexa Tech Park, Bangalore');
        ...
        setEditCompanyStamp(slip.companyStamp || latestCompanyInfo?.companyStamp || 'CODEXA');
