...
const AnnouncementsPage = () => {
    ...
    const fetchAnnouncements = async () => {
        try {
            ...
            setAnnouncements([
                { _id: '1', title: 'Welcome to Codexa!', content: 'We are excited to have you on board. Explore the new HR portal and stay tuned for updates.', createdAt: new Date().toISOString(), createdBy: { name: 'Admin' } },
                { _id: '2', title: 'New Leave Policy', content: 'Our leave policy has been updated. Please check the profile section for your remaining holiday balance.', createdAt: new Date(Date.now() - 172800000).toISOString(), createdBy: { name: 'Admin' } }
            ]);
        } finally {
            setLoading(false);
        }
