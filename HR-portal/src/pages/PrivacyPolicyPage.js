        ...
        <div className="min-h-screen bg-white text-black py-12 px-6 md:py-20 md:px-12 font-sans">
            <div className="max-w-4xl mx-auto space-y-8 animate-fade-in">
                ...
                <section className="space-y-6 leading-relaxed text-lg">
                    <p>
                        At <span className="font-bold">Codexa</span>, we prioritize the privacy and security of our employees' data. This Privacy Policy outlines how we collect, use, and protect your information within the HR Portal.
                    </p>
                    ...
                    <div className="space-y-4">
                        ...
                        <p>
                            By using the Codexa HR Portal and marking your attendance, you explicitly consent to the collection of your professional data and <span className="font-bold italic">real-time location verification</span> for administrative purposes.
                        </p>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <p>
                            ...
                            <br />
                            <span className="text-black font-medium">info@codexa.com</span>
                        </p>
                    </div>
                </section>
